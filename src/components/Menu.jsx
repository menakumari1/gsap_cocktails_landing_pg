...
const Menu = () => {
  ...
  return (
    <section id="menu" aria-labelledby="menu-heading" className="menu flex flex-col mt-0 pt-5">
        ...
        <div className=' scale-80'>
            ...
            <nav className="cocktail-tabs flex flex-row justify-center" aria-label="Cocktail Navigation">
